...
static char version[] = "Task Spooler v1.0.1 - a task queue system for the unix user.\n"
...
void parse_opts(int argc, char **argv)
{
    ...
    /* Parse options */
    while(1) {
        c = getopt(argc, argv, ":VhKgClnfmBEer:t:c:o:p:w:k:u:s:U:i:N:L:dS:D:R:");
...
static void print_help(const char *cmd)
{
    ...
    printf("Options listing jobs:\n");
    printf("  -e       only list jobs that exited with a non-zero exit code\n");
}
